...
- `example_identifier` is a student_identifier (or team_identifier) from the class roster. For compatibility with GitHub this must be 
...
To push issues the additional argument would be setting `push_issues` to TRUE. The two push arguments do not need to be run together or on different function calls.
