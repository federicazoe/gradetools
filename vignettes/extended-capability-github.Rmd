---
title: "4 - Extended gradetools Capability: Assignments on GitHub"
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{4 - Extended gradetools Capability: Assignments on GitHub}
...
Before using gradetools functionalities, the user needs to clone from GitHub all the repos where students have pushed their assignments. This can be done easily and quickly using the function [`local_repo_clone()`](https://rundel.github.io/ghclass/reference/local_repo.ht) from the ghclass package. 
