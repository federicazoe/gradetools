...
The GitHub compatible functionalities discussed in the vignette "Extended gradetools capability: Assignments on GitHub" also works with `assist_team_grading()`.