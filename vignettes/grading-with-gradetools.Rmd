...
resource_files:
  - images/example-repo.png
  - images/example-directory-quizzes-folder.png
  - images/class-roster.png
  - images/rubric-blank.png
  - images/rubric-filled.png
---
...
For this example we will use the example directory called example-directory-week09-regression in the [quizzes-collected-week09-regression](https://GitHub.com/gradetools-test-course/quizzes-collected-week09-regression) repository in our gradetools-test-course organization on GitHub. To follow along on your computer you can pull the repo from GitHub or use the "Download ZIP" option in the drop down list from the "Code" button on GitHub.
...
<iframe src="https://drive.google.com/file/d/1nYy3tvzgRJuhdBHkU0RTLGZYhEs3491H/preview" width="640" height="480" allow="autoplay"></iframe>
